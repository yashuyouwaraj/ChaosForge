...
export function GrafanaPanel({
  ...
  const src = getGrafanaEmbedUrl(path);
  const externalUrl = getGrafanaDashboardUrl(path);
        ...
        {!loaded && !failed && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-5 bg-black">
            ...
            <div className="text-center">
              <h3 className="text-xl font-bold">Connecting Grafana</h3>
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-8 text-center">
            <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-8">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-slate-400">
                ...
                unavailable. Start the Grafana container and retry connectivity.
              </p>
